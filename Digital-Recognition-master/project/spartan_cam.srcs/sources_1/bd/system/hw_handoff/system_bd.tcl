...
proc create_root_design { parentCell } {
  ...
  # Create instance: FOUR_TO_EIGHT_0, and set properties
  set FOUR_TO_EIGHT_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:FOUR_TO_EIGHT:1.0 FOUR_TO_EIGHT_0 ]

  # Create instance: SPI_DEMO_0, and set properties
  set SPI_DEMO_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:SPI_DEMO:1.0 SPI_DEMO_0 ]
  ...
  # Create port connections
  connect_bd_net -net FOUR_TO_EIGHT_0_Eight [get_bd_pins FOUR_TO_EIGHT_0/Eight] [get_bd_pins SPI_DEMO_0/DATA0]
  connect_bd_net -net MISO_1 [get_bd_ports MISO] [get_bd_pins SPI_DEMO_0/MISO]
  connect_bd_net -net SPI_DEMO_0_CS [get_bd_ports CS] [get_bd_pins SPI_DEMO_0/CS]
  connect_bd_net -net SPI_DEMO_0_MOSI [get_bd_ports MOSI] [get_bd_pins SPI_DEMO_0/MOSI]
  connect_bd_net -net SPI_DEMO_0_SCK [get_bd_ports SCK] [get_bd_pins SPI_DEMO_0/SCK]
  connect_bd_net -net SPI_DEMO_0_SPI_EN [get_bd_ports SPI_EN] [get_bd_pins SPI_DEMO_0/SPI_EN]
  ...
  connect_bd_net -net clk_in1_0_1 [get_bd_ports clk_in1_0] [get_bd_pins SPI_DEMO_0/clk_100MHz] [get_bd_pins clk_wiz_0/clk_in1]
  ...
  connect_bd_net -net digital_recognition_0_digital [get_bd_pins FOUR_TO_EIGHT_0/Four] [get_bd_pins digital_recognition_0/digital] [get_bd_pins lcd_num_0/num] [get_bd_pins rgb_test_0/num]
