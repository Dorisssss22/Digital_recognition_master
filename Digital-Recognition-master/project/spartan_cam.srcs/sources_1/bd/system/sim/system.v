...
(* CORE_GENERATION_INFO = "system,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=system,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=30,numReposBlks=24,numNonXlnxBlks=3,numHierBlks=6,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=5,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=4,da_board_cnt=1,da_mb_cnt=2,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "system.hwdef" *) 
module system
   (CS,
    MISO,
    MOSI,
  ...
  wire [7:0]FOUR_TO_EIGHT_0_Eight;
  wire MISO_1;
  wire SPI_DEMO_0_CS;
  wire SPI_DEMO_0_MOSI;
  wire SPI_DEMO_0_SCK;
  wire SPI_DEMO_0_SPI_EN;
  ...
  assign CS = SPI_DEMO_0_CS;
  assign MISO_1 = MISO;
  assign MOSI = SPI_DEMO_0_MOSI;
  assign SCK = SPI_DEMO_0_SCK;
  assign SPI_EN = SPI_DEMO_0_SPI_EN;
  ...
  system_FOUR_TO_EIGHT_0_0 FOUR_TO_EIGHT_0
       (.Eight(FOUR_TO_EIGHT_0_Eight),
        .Four(digital_recognition_0_digital));
  system_SPI_DEMO_0_0 SPI_DEMO_0
       (.CS(SPI_DEMO_0_CS),
        .DATA0(FOUR_TO_EIGHT_0_Eight),
        .MISO(MISO_1),
        .MOSI(SPI_DEMO_0_MOSI),
        .SCK(SPI_DEMO_0_SCK),
        .SPI_EN(SPI_DEMO_0_SPI_EN),
