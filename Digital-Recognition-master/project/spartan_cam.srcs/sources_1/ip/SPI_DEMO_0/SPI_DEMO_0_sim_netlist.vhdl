...
--               c:/Users/Administrator/Desktop/Digital-Recognition-master/project/spartan_cam.srcs/sources_1/ip/SPI_DEMO_0/SPI_DEMO_0_sim_netlist.vhdl
-- Design      : SPI_DEMO_0
...
entity SPI_DEMO_0_Clk_Division is
  port (
    Clk : out STD_LOGIC;
    clk_100MHz : in STD_LOGIC
  );
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of SPI_DEMO_0_Clk_Division : entity is "Clk_Division";
end SPI_DEMO_0_Clk_Division;

architecture STRUCTURE of SPI_DEMO_0_Clk_Division is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity SPI_DEMO_0_Clk_Division_0 is
  port (
    Clk_reg_0 : out STD_LOGIC;
    clk_100MHz : in STD_LOGIC
  );
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of SPI_DEMO_0_Clk_Division_0 : entity is "Clk_Division";
end SPI_DEMO_0_Clk_Division_0;

architecture STRUCTURE of SPI_DEMO_0_Clk_Division_0 is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity SPI_DEMO_0_SPI_Master is
  port (
    CS : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of SPI_DEMO_0_SPI_Master : entity is "SPI_Master";
end SPI_DEMO_0_SPI_Master;

architecture STRUCTURE of SPI_DEMO_0_SPI_Master is
...
SCK_Generator: entity work.SPI_DEMO_0_Clk_Division_0
     port map (
      Clk_reg_0 => \^clk_reg\,
...
entity SPI_DEMO_0_SPI_DEMO is
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of SPI_DEMO_0_SPI_DEMO : entity is "SPI_DEMO";
end SPI_DEMO_0_SPI_DEMO;

architecture STRUCTURE of SPI_DEMO_0_SPI_DEMO is
  signal \<const1>\ : STD_LOGIC;
  signal Clk : STD_LOGIC;
begin
  SPI_EN <= \<const1>\;
En_Generator: entity work.SPI_DEMO_0_Clk_Division
     port map (
      Clk => Clk,
      clk_100MHz => clk_100MHz
    );
SPI_Master0: entity work.SPI_DEMO_0_SPI_Master
     port map (
      CS => CS,
      Clk => Clk,
      Clk_reg => SCK,
...
entity SPI_DEMO_0 is
  ...
  attribute NotValidForBitStream of SPI_DEMO_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of SPI_DEMO_0 : entity is "SPI_DEMO_0,SPI_DEMO,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of SPI_DEMO_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of SPI_DEMO_0 : entity is "package_project";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of SPI_DEMO_0 : entity is "SPI_DEMO,Vivado 2018.3";
end SPI_DEMO_0;

architecture STRUCTURE of SPI_DEMO_0 is
begin
inst: entity work.SPI_DEMO_0_SPI_DEMO
     port map (
      CS => CS,
      DATA0(7 downto 0) => DATA0(7 downto 0),
      MISO => MISO,
