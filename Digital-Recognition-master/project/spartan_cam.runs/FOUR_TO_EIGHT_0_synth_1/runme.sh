...
HD_PWD='C:/Users/Administrator/Desktop/Digital-Recognition-master/project/spartan_cam.runs/FOUR_TO_EIGHT_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FOUR_TO_EIGHT_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FOUR_TO_EIGHT_0.tcl
