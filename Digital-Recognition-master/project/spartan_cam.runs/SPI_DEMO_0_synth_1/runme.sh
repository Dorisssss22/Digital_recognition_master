...
HD_PWD='C:/Users/Administrator/Desktop/Digital-Recognition-master/project/spartan_cam.runs/SPI_DEMO_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SPI_DEMO_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SPI_DEMO_0.tcl
