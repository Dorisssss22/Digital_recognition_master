...
#
# Generated by export_simulation on Wed Jul 29 20:42:46 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './FOUR_TO_EIGHT_0.sh' script.

./FOUR_TO_EIGHT_0.sh -reset_run
...
./FOUR_TO_EIGHT_0.sh -noclean_files

For more information on the script, please type './FOUR_TO_EIGHT_0.sh -help'.
