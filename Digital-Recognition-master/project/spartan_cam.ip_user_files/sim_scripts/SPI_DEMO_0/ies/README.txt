...
#
# Generated by export_simulation on Wed Jul 29 20:43:19 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './SPI_DEMO_0.sh' script.

./SPI_DEMO_0.sh -reset_run
...
./SPI_DEMO_0.sh -noclean_files

For more information on the script, please type './SPI_DEMO_0.sh -help'.
